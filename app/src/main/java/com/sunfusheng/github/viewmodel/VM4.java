 ...
 */
public class VM4<T1, T2, T3, T4> extends ViewModel {
    ...
    public void put(T1 data1, T2 data2, T3 data3, T4 data4) {
        VmUtil.setValue(() -> {
            liveData1.setValue(data1);
            liveData2.setValue(data2);
            liveData3.setValue(data3);
            liveData4.setValue(data4);
        });
    }
    ...
    public void onNotify(@NonNull Activity activity, Observer<T1> observer1, Observer<T2> observer2, Observer<T3> observer3, Observer<T4> observer4) {
        ...
        liveData4.observe(VmUtil.getActivity(activity), observer4);
    }
    ...
    public void onNotify(@NonNull Fragment fragment, Observer<T1> observer1, Observer<T2> observer2, Observer<T3> observer3, Observer<T4> observer4) {
        onNotify(VmUtil.getActivity(fragment.getActivity()), observer1, observer2, observer3, observer4);
    }
