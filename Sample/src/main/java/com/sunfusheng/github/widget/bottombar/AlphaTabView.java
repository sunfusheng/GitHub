...
public class AlphaTabView extends View {
    ...
    private int mDrawablePadding = 5;             //文字和图片之间的距离 5dp
    ...
    public AlphaTabView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDrawablePadding = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mDrawablePadding, getResources().getDisplayMetrics());
        //获取所有的自定义属性
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mText != null && mIconNormal != null) {
            availableHeight -= (mTextBound.height() + mDrawablePadding);
            //计算出图标可以绘制的画布大小
            ...
            int textTop = mIconAvailableRect.bottom + mDrawablePadding;
